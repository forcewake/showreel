...
(function () {
  'use strict';
  var data = JSON.parse(document.getElementById('showreel-data').textContent);
...
def export_html(
    ...
    html = f"""<!doctype html>
<!-- Generated by showreel v{__version__} — fully self-contained, no network required. -->
<html lang="en">
<head>
<meta charset="utf-8">
...
<div id="markers"></div>
<div class="hint">space = play/pause · ←/→ = ±5s · generated by showreel</div>
<script type="application/json" id="showreel-data">{data_json}</script>
